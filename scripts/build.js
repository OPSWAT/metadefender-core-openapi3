...
var buildDocs = function(openAPISpecPath, destFolder) {    
    __exec('node ./node_modules/redoc-cli/index.js bundle -o ' + destFolder + '/index.html ' + openAPISpecPath + " --options.jsonSampleExpandLevel=7 --options.expandResponses=all", "redoc bundle");   
