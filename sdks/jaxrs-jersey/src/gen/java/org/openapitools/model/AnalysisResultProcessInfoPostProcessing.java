...
@JsonPropertyOrder({
  AnalysisResultProcessInfoPostProcessing.JSON_PROPERTY_ACTIONS_FAILED,
  AnalysisResultProcessInfoPostProcessing.JSON_PROPERTY_ACTIONS_RAN,
  AnalysisResultProcessInfoPostProcessing.JSON_PROPERTY_CONVERTED_DESTINATION,
  AnalysisResultProcessInfoPostProcessing.JSON_PROPERTY_CONVERTED_TO,
  AnalysisResultProcessInfoPostProcessing.JSON_PROPERTY_COPY_MOVE_DESTINATION,
  AnalysisResultProcessInfoPostProcessing.JSON_PROPERTY_SANITIZATION_DETAILS
})
...
public class AnalysisResultProcessInfoPostProcessing   {
  public static final String JSON_PROPERTY_ACTIONS_FAILED = "actions_failed";
  @JsonProperty(JSON_PROPERTY_ACTIONS_FAILED)
  private String actionsFailed;

  public static final String JSON_PROPERTY_ACTIONS_RAN = "actions_ran";
  @JsonProperty(JSON_PROPERTY_ACTIONS_RAN)
  private String actionsRan;

  public static final String JSON_PROPERTY_CONVERTED_DESTINATION = "converted_destination";
  @JsonProperty(JSON_PROPERTY_CONVERTED_DESTINATION)
  private String convertedDestination;

  public static final String JSON_PROPERTY_CONVERTED_TO = "converted_to";
  @JsonProperty(JSON_PROPERTY_CONVERTED_TO)
  private String convertedTo;

  public static final String JSON_PROPERTY_COPY_MOVE_DESTINATION = "copy_move_destination";
  @JsonProperty(JSON_PROPERTY_COPY_MOVE_DESTINATION)
  private String copyMoveDestination;

  public static final String JSON_PROPERTY_SANITIZATION_DETAILS = "sanitization_details";
  @JsonProperty(JSON_PROPERTY_SANITIZATION_DETAILS)
