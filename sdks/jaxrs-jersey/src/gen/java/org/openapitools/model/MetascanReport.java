...
@JsonPropertyOrder({
  MetascanReport.JSON_PROPERTY_DATA_ID,
  MetascanReport.JSON_PROPERTY_PROGRESS_PERCENTAGE,
  MetascanReport.JSON_PROPERTY_SCAN_ALL_RESULT_A,
  MetascanReport.JSON_PROPERTY_SCAN_ALL_RESULT_I,
  MetascanReport.JSON_PROPERTY_START_TIME,
  MetascanReport.JSON_PROPERTY_TOTAL_AVS,
  MetascanReport.JSON_PROPERTY_TOTAL_TIME,
  MetascanReport.JSON_PROPERTY_SCAN_DETAILS
})
...
public class MetascanReport   {
  ...
  public static final String JSON_PROPERTY_SCAN_DETAILS = "scan_details";
  @JsonProperty(JSON_PROPERTY_SCAN_DETAILS)
