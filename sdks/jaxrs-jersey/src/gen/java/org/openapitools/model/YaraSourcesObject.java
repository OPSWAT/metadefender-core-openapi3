...
@JsonPropertyOrder({
  YaraSourcesObject.JSON_PROPERTY_LOCAL_SOURCES,
  YaraSourcesObject.JSON_PROPERTY_HTTP_SOURCES
})
...
public class YaraSourcesObject   {
  public static final String JSON_PROPERTY_LOCAL_SOURCES = "local_sources";
  @JsonProperty(JSON_PROPERTY_LOCAL_SOURCES)
  private List<YaraSourcesObjectLocalSources> localSources = null;

  public static final String JSON_PROPERTY_HTTP_SOURCES = "http_sources";
  @JsonProperty(JSON_PROPERTY_HTTP_SOURCES)
