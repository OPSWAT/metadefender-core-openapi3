...
@JsonPropertyOrder({
  AVEngineScanReport.JSON_PROPERTY_DEF_TIME,
  AVEngineScanReport.JSON_PROPERTY_ENG_ID,
  AVEngineScanReport.JSON_PROPERTY_LOCATION,
  AVEngineScanReport.JSON_PROPERTY_SCAN_RESULT_I,
  AVEngineScanReport.JSON_PROPERTY_SCAN_TIME,
  AVEngineScanReport.JSON_PROPERTY_THREAT_FOUND,
  AVEngineScanReport.JSON_PROPERTY_WAIT_TIME
})
...
public class AVEngineScanReport   {
  ...
  public static final String JSON_PROPERTY_SCAN_RESULT_I = "scan_result_i";
  @JsonProperty(JSON_PROPERTY_SCAN_RESULT_I)
  private Integer scanResultI;

  public static final String JSON_PROPERTY_SCAN_TIME = "scan_time";
  @JsonProperty(JSON_PROPERTY_SCAN_TIME)
  private Integer scanTime;

  public static final String JSON_PROPERTY_THREAT_FOUND = "threat_found";
  @JsonProperty(JSON_PROPERTY_THREAT_FOUND)
