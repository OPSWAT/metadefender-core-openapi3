...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SkipList :  IEquatable<SkipList>, IValidatableObject
    {
        /// <summary>
        ...
        public SkipList(Object blacklist = default(Object), Object skip = default(Object), Object whitelist = default(Object))
        {
        ...
        {
            return this.Equals(input as SkipList);
        }

        /// <summary>
        /// Returns true if SkipList instances are equal
        /// </summary>
        /// <param name="input">Instance of SkipList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SkipList input)
        {
            if (input == null)
                return false;
