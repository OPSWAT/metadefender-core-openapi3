...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject2 :  IEquatable<InlineObject2>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="oldPassword">The current password in plain text.</param>
        /// <param name="newPassword">The new password in plain text.</param>
        public InlineObject2(string oldPassword = default(string), string newPassword = default(string))
        {
        ...
        /// </summary>
        /// <value>The current password in plain text</value>
