...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineResponse2008 :  IEquatable<InlineResponse2008>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="InlineResponse2008" /> class.
        /// </summary>
        /// <param name="dataId">dataId (required).</param>
        public InlineResponse2008(string dataId = default(string))
        {
            // to ensure "dataId" is required (not null)
            if (dataId == null)
            {
                throw new InvalidDataException("dataId is a required property for InlineResponse2008 and cannot be null");
            }
            else
            {
                this.DataId = dataId;
