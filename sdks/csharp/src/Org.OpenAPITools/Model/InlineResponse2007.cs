...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineResponse2007 :  IEquatable<InlineResponse2007>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Current status of generating the package.</value>
        ...
        /// </summary>
        /// <param name="status">Current status of generating the package..</param>
        /// <param name="startTime">Used only when status is inprogress, otherwise its empty.</param>
        /// <param name="issues">issues.</param>
        public InlineResponse2007(StatusEnum? status = default(StatusEnum?), string startTime = default(string), InlineResponse2007Issues issues = default(InlineResponse2007Issues))
        {
            this.Status = status;
        ...
        /// </summary>
        /// <value>Used only when status is inprogress, otherwise its empty</value>
        ...
        public InlineResponse2007Issues Issues { get; set; }
