...
public interface AuthApi  {
    ...
    @ApiOperation(value = "Change Password", tags={ "auth",  })
    @ApiResponses(value = { 
    ...
    public void userChangePass(@HeaderParam("apikey")   String apikey, @Valid InlineObject2 inlineObject2);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = UserLogin.class),
        @ApiResponse(code = 403, message = "Invalid credentials", response = InlineResponse403.class),
        @ApiResponse(code = 500, message = "Unexpected event on server", response = InlineResponse500.class) })
    public UserLogin userLogin(@Valid InlineObject inlineObject);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 403, message = "Invalid user information."),
        @ApiResponse(code = 500, message = "Unexpected event on server", response = InlineResponse500.class) })
    public void userLogout(@HeaderParam("apikey")   String apikey);
}
