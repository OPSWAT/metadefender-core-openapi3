...
package openapi
// DlpResponseDlpInfo Information on matched sensitive data
type DlpResponseDlpInfo struct {
	...
	Hits DlpResponseDlpInfoHits `json:"hits,omitempty"`
	MetadataRemoval DlpResponseDlpInfoMetadataRemoval `json:"metadata_removal,omitempty"`
	Redact DlpResponseDlpInfoRedact `json:"redact,omitempty"`
	...
	Watermark DlpResponseDlpInfoWatermark `json:"watermark,omitempty"`
}
