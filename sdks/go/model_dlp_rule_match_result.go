...
package openapi
// DlpRuleMatchResult An entry detailing the match.
type DlpRuleMatchResult struct {
	...
	CertaintyScore int32 `json:"certainty_score,omitempty"`
	// The matched data.
	Hit string `json:"hit,omitempty"`
	// If file was redacted or not.
	IsRedacted bool `json:"isRedacted,omitempty"`
