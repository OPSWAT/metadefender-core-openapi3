...
package openapi
// StatNodesStatuses Node status
type StatNodesStatuses struct {
	...
	Engines []StatNodesEngines `json:"engines,omitempty"`
	// Reported available disk on that Node (in bytes).
	FreeDiskSpace int32 `json:"free_disk_space,omitempty"`
	// Node identfier
	Id string `json:"id,omitempty"`
	// A list of all potentials problems on that Node.
	Issues []StatNodesIssues `json:"issues,omitempty"`
	...
	ScanQueue int32 `json:"scan_queue,omitempty"`
