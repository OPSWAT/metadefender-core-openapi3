...
// UserChangePassOpts Optional parameters for the method 'UserChangePass'
type UserChangePassOpts struct {
 ...
 * @param optional nil or *UserChangePassOpts - Optional Parameters:
...
*/
func (a *AuthApiService) UserChangePass(ctx _context.Context, localVarOptionals *UserChangePassOpts) (*_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/user/changepassword"
...
// UserLoginOpts Optional parameters for the method 'UserLogin'
...
@return UserLogin
*/
func (a *AuthApiService) UserLogin(ctx _context.Context, localVarOptionals *UserLoginOpts) (UserLogin, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
// UserLogoutOpts Optional parameters for the method 'UserLogout'
 ...
 * @param "Apikey" (optional.String) -  Generated `session_id` from [Login](#operation/userLogin) call can be used as an `apikey` for API calls that require authentication.                
*/
func (a *AuthApiService) UserLogout(ctx _context.Context, localVarOptionals *UserLogoutOpts) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
