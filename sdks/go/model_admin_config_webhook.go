...
type AdminConfigWebhook struct {
	...
	Maxretrytime float32 `json:"maxretrytime,omitempty"`
	// in milliseconds
	Delayduration float32 `json:"delayduration,omitempty"`
	// in milliseconds
	Deplayprogression float32 `json:"deplayprogression,omitempty"`
}
