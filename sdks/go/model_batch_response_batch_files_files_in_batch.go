...
package openapi
// BatchResponseBatchFilesFilesInBatch struct for BatchResponseBatchFilesFilesInBatch
type BatchResponseBatchFilesFilesInBatch struct {
	// Unique identifer for the file.
	DataId string `json:"data_id,omitempty"`
	// Total number of engines that detected this file.
	DetectedBy int32 `json:"detected_by,omitempty"`
	...
	ProcessInfo BatchResponseBatchFilesProcessInfo `json:"process_info,omitempty"`
	...
	ScanAllResultA ProcessingResultsStringEnum `json:"scan_all_result_a,omitempty"`
	// The overall scan result as index in the Processing Results table.
	ScanAllResultI ProcessingResultsIndexEnum `json:"scan_all_result_i,omitempty"`
	// The total number of engines used to analyze this file.
	ScannedWith int32 `json:"scanned_with,omitempty"`
}
