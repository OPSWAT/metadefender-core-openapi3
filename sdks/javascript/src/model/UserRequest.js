...
import UserRequestAllOf from './UserRequestAllOf';
...
class UserRequest {
     ...
     * @extends module:model/UserResponse
     * @implements module:model/UserResponse
     * @implements module:model/UserRequestAllOf
     */
    constructor() { 
        UserResponse.initialize(this);UserRequestAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            UserResponse.constructFromObject(data, obj);
            UserRequestAllOf.constructFromObject(data, obj);
 ...
 */
UserResponse.prototype['apikey'] = undefined;
/**
 * To which User Directories belongs to (LOCAL/System/etc.)
 * @member {Number} directory_id
 */
UserResponse.prototype['directory_id'] = undefined;
/**
 ...
 * @member {Object} ui_settings
 */
UserResponse.prototype['ui_settings'] = undefined;
// Implement UserRequestAllOf interface:
/**
 * The user's password
 * @member {String} password
 */
