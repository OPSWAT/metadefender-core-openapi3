...
import StatNodesStatuses from './StatNodesStatuses';
...
class InlineResponse20013 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('external_nodes_allowed')) {
                obj['external_nodes_allowed'] = ApiClient.convertToType(data['external_nodes_allowed'], 'Boolean');
            }
            if (data.hasOwnProperty('max_node_count')) {
                obj['max_node_count'] = ApiClient.convertToType(data['max_node_count'], 'Number');
            }
            if (data.hasOwnProperty('statuses')) {
                obj['statuses'] = ApiClient.convertToType(data['statuses'], [StatNodesStatuses]);
            }
        }
        return obj;
    }
 ...
 * @member {Boolean} external_nodes_allowed
 */
InlineResponse20013.prototype['external_nodes_allowed'] = undefined;

/**
 * Remaining available slots to connect to this instance.
 * @member {Number} max_node_count
 */
InlineResponse20013.prototype['max_node_count'] = undefined;

/**
 * Array with a status for each attached node.
 * @member {Array.<module:model/StatNodesStatuses>} statuses
 */
InlineResponse20013.prototype['statuses'] = undefined;
