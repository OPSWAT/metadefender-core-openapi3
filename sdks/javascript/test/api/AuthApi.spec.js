...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetaDefenderCore.AuthApi();
  });
  ...
  describe('AuthApi', function() {
    describe('userChangePass', function() {
      it('should call userChangePass successfully', function(done) {
        //uncomment below and update the code to test userChangePass
        //instance.userChangePass(function(error) {
