...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetaDefenderCore.InlineResponse20013();
  });
  ...
  describe('InlineResponse20013', function() {
    it('should create an instance of InlineResponse20013', function() {
      ...
      //var instane = new MetaDefenderCore.InlineResponse20013();
      //expect(instance).to.be.a(MetaDefenderCore.InlineResponse20013);
    });

    it('should have the property externalNodesAllowed (base name: "external_nodes_allowed")', function() {
      // uncomment below and update the code to test the property externalNodesAllowed
      //var instane = new MetaDefenderCore.InlineResponse20013();
