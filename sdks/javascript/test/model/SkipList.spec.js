...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetaDefenderCore.SkipList();
  });
  ...
  describe('SkipList', function() {
    it('should create an instance of SkipList', function() {
      // uncomment below and update the code to test SkipList
      //var instane = new MetaDefenderCore.SkipList();
      //expect(instance).to.be.a(MetaDefenderCore.SkipList);
    });
