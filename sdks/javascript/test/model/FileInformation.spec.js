...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetaDefenderCore.FileInformation();
  });
  ...
  describe('FileInformation', function() {
    it('should create an instance of FileInformation', function() {
      ...
      //var instane = new MetaDefenderCore.FileInformation();
      //expect(instance).to.be.a(MetaDefenderCore.FileInformation);
    });
    ...
    it('should have the property uploadTimestamp (base name: "upload_timestamp")', function() {
      // uncomment below and update the code to test the property uploadTimestamp
      //var instane = new MetaDefenderCore.FileInformation();
      //expect(instance).to.be();
    });
