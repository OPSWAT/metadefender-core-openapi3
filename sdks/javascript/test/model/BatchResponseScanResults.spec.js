...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetaDefenderCore.BatchResponseScanResults();
  });
  ...
  describe('BatchResponseScanResults', function() {
    it('should create an instance of BatchResponseScanResults', function() {
      // uncomment below and update the code to test BatchResponseScanResults
      //var instane = new MetaDefenderCore.BatchResponseScanResults();
      //expect(instance).to.be.a(MetaDefenderCore.BatchResponseScanResults);
    });
