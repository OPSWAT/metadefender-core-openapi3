...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetaDefenderCore.MetascanReport();
  });
  ...
  describe('MetascanReport', function() {
    it('should create an instance of MetascanReport', function() {
      // uncomment below and update the code to test MetascanReport
      //var instane = new MetaDefenderCore.MetascanReport();
      //expect(instance).to.be.a(MetaDefenderCore.MetascanReport);
    });
    ...
    it('should have the property totalAvs (base name: "total_avs")', function() {
      // uncomment below and update the code to test the property totalAvs
      //var instane = new MetaDefenderCore.MetascanReport();
      //expect(instance).to.be();
    });
    ...
    it('should have the property scanDetails (base name: "scan_details")', function() {
      // uncomment below and update the code to test the property scanDetails
      //var instane = new MetaDefenderCore.MetascanReport();
      //expect(instance).to.be();
    });
