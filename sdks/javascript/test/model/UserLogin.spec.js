...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetaDefenderCore.UserLogin();
  });
  ...
  describe('UserLogin', function() {
    it('should create an instance of UserLogin', function() {
      // uncomment below and update the code to test UserLogin
      //var instane = new MetaDefenderCore.UserLogin();
      //expect(instance).to.be.a(MetaDefenderCore.UserLogin);
    });
