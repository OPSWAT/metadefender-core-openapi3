...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetaDefenderCore.BatchId();
  });
  ...
  describe('BatchId', function() {
    it('should create an instance of BatchId', function() {
      // uncomment below and update the code to test BatchId
      //var instane = new MetaDefenderCore.BatchId();
      //expect(instance).to.be.a(MetaDefenderCore.BatchId);
    });
