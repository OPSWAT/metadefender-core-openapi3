...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetaDefenderCore.BatchResponse();
  });
  ...
  describe('BatchResponse', function() {
    it('should create an instance of BatchResponse', function() {
      ...
      //var instane = new MetaDefenderCore.BatchResponse();
      //expect(instance).to.be.a(MetaDefenderCore.BatchResponse);
    });

    it('should have the property batchFiles (base name: "batch_files")', function() {
      // uncomment below and update the code to test the property batchFiles
      //var instane = new MetaDefenderCore.BatchResponse();
