...
public class StatsApiTest {
     ...
     */
    @Test
    public void enginesStatusTest() throws ApiException {
        String apikey = null;
        List<InlineResponse20012> response = api.enginesStatus(apikey);
     ...
     */
    @Test
    public void nodesStatusTest() throws ApiException {
        String apikey = null;
        List<InlineResponse20013> response = api.nodesStatus(apikey);
     ...
     */
    @Test
    public void productVersionTest() throws ApiException {
        String apikey = null;
        InlineResponse20011 response = api.productVersion(apikey);
