 ...
 */
@JsonAdapter(ProcessingResultsIndexEnum.Adapter.class)
public enum ProcessingResultsIndexEnum {
  ...
  public static class Adapter extends TypeAdapter<ProcessingResultsIndexEnum> {
    @Override
    public void write(final JsonWriter jsonWriter, final ProcessingResultsIndexEnum enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ProcessingResultsIndexEnum read(final JsonReader jsonReader) throws IOException {
      Integer value = jsonReader.nextInt();
      return ProcessingResultsIndexEnum.fromValue(value);
    }
  }
}
