...
QString OAIUserRequest::getApikey() const {
    return apikey;
}
void OAIUserRequest::setApikey(const QString &apikey) {
    this->apikey = apikey;
    this->m_apikey_isSet = true;
}

qint32 OAIUserRequest::getDirectoryId() const {
    return directory_id;
}
void OAIUserRequest::setDirectoryId(const qint32 &directory_id) {
    this->directory_id = directory_id;
    this->m_directory_id_isSet = true;
}

QString OAIUserRequest::getDisplayName() const {
    return display_name;
}
void OAIUserRequest::setDisplayName(const QString &display_name) {
    this->display_name = display_name;
    this->m_display_name_isSet = true;
}

QString OAIUserRequest::getEmail() const {
    return email;
}
void OAIUserRequest::setEmail(const QString &email) {
    this->email = email;
    this->m_email_isSet = true;
}

QString OAIUserRequest::getName() const {
    return name;
}
void OAIUserRequest::setName(const QString &name) {
    this->name = name;
    this->m_name_isSet = true;
}

QList<QString> OAIUserRequest::getRoles() const {
    return roles;
}
void OAIUserRequest::setRoles(const QList<QString> &roles) {
    this->roles = roles;
    this->m_roles_isSet = true;
}

OAIObject OAIUserRequest::getUiSettings() const {
    return ui_settings;
}
void OAIUserRequest::setUiSettings(const OAIObject &ui_settings) {
    this->ui_settings = ui_settings;
    this->m_ui_settings_isSet = true;
}

QString OAIUserRequest::getPassword() const {
    return password;
}
void OAIUserRequest::setPassword(const QString &password) {
