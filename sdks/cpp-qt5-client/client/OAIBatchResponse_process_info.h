...
/*
 * OAIBatchResponse_process_info.h
 *
 * Overall batch process result
 */

#ifndef OAIBatchResponse_process_info_H
#define OAIBatchResponse_process_info_H
...
class OAIBatchResponse_process_info : public OAIObject {
public:
    OAIBatchResponse_process_info();
    OAIBatchResponse_process_info(QString json);
    ~OAIBatchResponse_process_info() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchResponse_process_info)

#endif // OAIBatchResponse_process_info_H
