...
/*
 * OAI_stat_nodes_engines.h
 *
 * Engine summary
 */

#ifndef OAI_stat_nodes_engines_H
#define OAI_stat_nodes_engines_H
...
class OAI_stat_nodes_engines : public OAIObject {
public:
    OAI_stat_nodes_engines();
    OAI_stat_nodes_engines(QString json);
    ~OAI_stat_nodes_engines() override;
    ...
    void setDbVer(const QString &db_ver);
...
Q_DECLARE_METATYPE(OpenAPI::OAI_stat_nodes_engines)

#endif // OAI_stat_nodes_engines_H
