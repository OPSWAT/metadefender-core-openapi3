...
public:
    ...
    bool isExternalNodesAllowed() const;
    void setExternalNodesAllowed(const bool &external_nodes_allowed);

    qint32 getMaxNodeCount() const;
    void setMaxNodeCount(const qint32 &max_node_count);

    QList<OAI_stat_nodes_statuses> getStatuses() const;
    void setStatuses(const QList<OAI_stat_nodes_statuses> &statuses);
...
private:
    ...
    bool external_nodes_allowed;
    bool m_external_nodes_allowed_isSet;
    bool m_external_nodes_allowed_isValid;

    qint32 max_node_count;
    bool m_max_node_count_isSet;
    bool m_max_node_count_isValid;

    QList<OAI_stat_nodes_statuses> statuses;
