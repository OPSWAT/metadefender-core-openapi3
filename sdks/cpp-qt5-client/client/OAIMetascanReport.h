...
#ifndef OAIMetascanReport_H
#define OAIMetascanReport_H
...
class OAIMetascanReport : public OAIObject {
public:
    OAIMetascanReport();
    OAIMetascanReport(QString json);
    ~OAIMetascanReport() override;
    ...
    OAIMetascanReport_scan_details getScanDetails() const;
    void setScanDetails(const OAIMetascanReport_scan_details &scan_details);
...
private:
    ...
    OAIMetascanReport_scan_details scan_details;
    bool m_scan_details_isSet;
    bool m_scan_details_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIMetascanReport)

#endif // OAIMetascanReport_H
