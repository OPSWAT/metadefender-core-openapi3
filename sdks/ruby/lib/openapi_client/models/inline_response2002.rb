...
module OpenapiClient
  class InlineResponse2002
    ...
    def valid?
      result_validator = EnumAttributeValidator.new('String', ["Engine is pinned", "Database is pinned", "Both engine and database are pinned"])
    ...
    def result=(result)
      validator = EnumAttributeValidator.new('String', ["Engine is pinned", "Database is pinned", "Both engine and database are pinned"])
