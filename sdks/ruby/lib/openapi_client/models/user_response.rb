...
module OpenapiClient
  ...
  class UserResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'ui_settings')
        self.ui_settings = attributes[:'ui_settings']
      end
    end
    ...
    def hash
      [apikey, directory_id, display_name, email, name, roles, ui_settings].hash
    end
