...
module OpenapiClient
  ...
  class LicenseInformation
    ...
    attr_accessor :licensed_engines
    ...
    attr_accessor :online_activated
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::LicenseInformation` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::LicenseInformation`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'licensed_engines')
        if (value = attributes[:'licensed_engines']).is_a?(Array)
          self.licensed_engines = value
        end
      end
      ...
      if attributes.key?(:'online_activated')
        self.online_activated = attributes[:'online_activated']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          licensed_engines == o.licensed_engines &&
          max_node_count == o.max_node_count &&
          online_activated == o.online_activated &&
    ...
    def hash
      [days_left, deployment, expiration, licensed_engines, max_node_count, online_activated, product_id, product_name].hash
    end
