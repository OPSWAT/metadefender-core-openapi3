...
module OpenapiClient
  ...
  class DLPResponseDlpInfo
    ...
    attr_accessor :metadata_removal
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::DLPResponseDlpInfo` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::DLPResponseDlpInfo`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'metadata_removal')
        self.metadata_removal = attributes[:'metadata_removal']
      end
    ...
    def valid?
      ...
      verdict_validator = EnumAttributeValidator.new('Integer', [0, 1, 2, 3, 4])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          filename == o.filename &&
          hits == o.hits &&
          metadata_removal == o.metadata_removal &&
          redact == o.redact &&
          severity == o.severity &&
          verdict == o.verdict &&
    ...
    def hash
      [certainty, errors, filename, hits, metadata_removal, redact, severity, verdict, watermark].hash
    end
