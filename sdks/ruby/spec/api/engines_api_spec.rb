...
# Unit tests for OpenapiClient::EnginesApi
...
describe 'EnginesApi' do
  ...
  describe 'test an instance of EnginesApi' do
    it 'should create an instance of EnginesApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::EnginesApi)
    end
  end

  # unit tests for engine_disable
  # Disable engines
  ...
  describe 'engine_disable test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for engine_enable
  # Enable engines
  ...
  describe 'engine_enable test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for engine_pin
  ...
  describe 'engine_pin test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for engine_unpin
