...
# Unit tests for OpenapiClient::InlineResponse20013
...
describe 'InlineResponse20013' do
  ...
  describe 'test an instance of InlineResponse20013' do
    it 'should create an instance of InlineResponse20013' do
      expect(@instance).to be_instance_of(OpenapiClient::InlineResponse20013)
    end
  end
  describe 'test attribute "external_nodes_allowed"' do
    it 'should work' do
