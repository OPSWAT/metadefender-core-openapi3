...
#
package WWW::OpenAPIClient::Object::InlineResponse20012;
...
__PACKAGE__->method_documentation({
    ...
    'engine_type' => {
        datatype => 'string',
        base_name => 'engine_type',
        description => 'Engine&#39;s type:    * av   * archive   * filetype ',
        format => '',
        read_only => '',
            },
    'state' => {
        datatype => 'string',
        base_name => 'state',
        description => 'Status of the engine:   * downloading   * downloaded   * staging   * production   * removed   * temporary failed   * permanently failed   * content invalid   * download failed ',
        format => '',
        read_only => '',
            },
});
