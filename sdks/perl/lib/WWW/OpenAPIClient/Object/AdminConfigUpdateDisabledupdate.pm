...
#
package WWW::OpenAPIClient::Object::AdminConfigUpdateDisabledupdate;
...
__PACKAGE__->class_documentation({description => 'The JSON below mean that from Friday to Sunday (week starts on Monday (1), ends on Sunday (7)) from 8:00 to 16:00 you do not want to distribute packages. &lt;i&gt;From and to is the distance in minutes from 0:00 (8:00 → 480 minutes, 16:00 → 960 minutes)&lt;i&gt; ',
