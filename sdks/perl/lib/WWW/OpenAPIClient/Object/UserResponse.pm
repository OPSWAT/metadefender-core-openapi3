...
#
package WWW::OpenAPIClient::Object::UserResponse;
...
__PACKAGE__->class_documentation({description => 'User object in MetaDefender.',
                                  class => 'UserResponse',
                                  required => [], # TODO
}                                 );
