...
#
package WWW::OpenAPIClient::Object::MetascanReport;
...
__PACKAGE__->class_documentation({description => 'Result of the scanning process.',
...
__PACKAGE__->method_documentation({
    ...
    'total_time' => {
        datatype => 'int',
        base_name => 'total_time',
        description => 'Total time elapsed during scan (in milliseconds).',
        format => '',
        read_only => '',
            },
    'scan_details' => {
        datatype => 'MetascanReportScanDetails',
        base_name => 'scan_details',
        description => '',
        format => '',
        read_only => '',
            },
