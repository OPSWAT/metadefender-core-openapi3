...
#
package WWW::OpenAPIClient::Object::NewUserRoleRequestRights;
...
__PACKAGE__->class_documentation({description => 'A list of rights for each permission',
