...
#
package WWW::OpenAPIClient::Object::AdminConfigSession;
...
__PACKAGE__->class_documentation({description => 'API object for /admin/config/session',
...
__PACKAGE__->method_documentation({
    'absolute_session_timeout' => {
        datatype => 'int',
        base_name => 'absoluteSessionTimeout',
    ...
    'allow_cross_ip_sessions' => {
        datatype => 'boolean',
        base_name => 'allowCrossIpSessions',
    ...
    'allow_duplicate_session' => {
        datatype => 'boolean',
        base_name => 'allowDuplicateSession',
