...
#
package WWW::OpenAPIClient::Object::AnalysisResultProcessInfo;
...
__PACKAGE__->class_documentation({description => 'Processing information',
...
__PACKAGE__->method_documentation({
    ...
    'file_type_skipped_scan' => {
        datatype => 'boolean',
        base_name => 'file_type_skipped_scan',
    ...
    'post_processing' => {
        datatype => 'AnalysisResultProcessInfoPostProcessing',
        base_name => 'post_processing',
        description => '',
        format => '',
        read_only => '',
            },
