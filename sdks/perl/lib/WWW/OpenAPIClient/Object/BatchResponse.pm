...
#
package WWW::OpenAPIClient::Object::BatchResponse;
...
__PACKAGE__->class_documentation({description => 'The response for a Batch status request.',
                                  class => 'BatchResponse',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    'batch_files' => {
        datatype => 'BatchResponseBatchFiles',
        base_name => 'batch_files',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'process_info' => {
        datatype => 'BatchResponseProcessInfo',
    ...
    'scan_results' => {
        datatype => 'BatchResponseScanResults',
