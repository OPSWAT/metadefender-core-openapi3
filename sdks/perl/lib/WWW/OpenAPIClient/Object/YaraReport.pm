...
#
package WWW::OpenAPIClient::Object::YaraReport;
...
__PACKAGE__->class_documentation({description => 'Information on data that matched yara rules',
                                  class => 'YaraReport',
                                  required => [], # TODO
}                                 );
