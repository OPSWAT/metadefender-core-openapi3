...
#
package WWW::OpenAPIClient::Object::LicenseInformation;
...
__PACKAGE__->class_documentation({description => 'Information about the licensed product (product type, number of activations, deploymentId, expiration date and days left)',
