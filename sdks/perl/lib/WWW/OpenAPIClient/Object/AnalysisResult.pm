...
#
package WWW::OpenAPIClient::Object::AnalysisResult;
...
__PACKAGE__->method_documentation({
    ...
    'process_info' => {
        datatype => 'AnalysisResultProcessInfo',
    ...
    'vulnerability_info' => {
        datatype => 'VulnerabilityResponse',
        base_name => 'vulnerability_info',
        description => '',
        format => '',
        read_only => '',
            },
