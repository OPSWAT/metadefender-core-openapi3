...
#
package WWW::OpenAPIClient::Object::StatNodesStatuses;
...
__PACKAGE__->class_documentation({description => 'Node status',
...
__PACKAGE__->method_documentation({
    ...
    'engines' => {
        datatype => 'ARRAY[StatNodesEngines]',
        base_name => 'engines',
    ...
    'issues' => {
        datatype => 'ARRAY[StatNodesIssues]',
        base_name => 'issues',
