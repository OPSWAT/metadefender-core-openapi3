...
#
package WWW::OpenAPIClient::Object::NewUserRoleRequest;
...
__PACKAGE__->class_documentation({description => 'MetaDefender user role describing object.',
...
__PACKAGE__->method_documentation({
    ...
    'rights' => {
        datatype => 'NewUserRoleRequestRights',
        base_name => 'rights',
        description => '',
        format => '',
        read_only => '',
