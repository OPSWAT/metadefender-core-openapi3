...
#
package WWW::OpenAPIClient::Object::YaraSourcesObjectHttpSources;
...
__PACKAGE__->class_documentation({description => 'Object defining the URL and if this source is being used.',
