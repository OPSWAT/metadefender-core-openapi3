...
#
package WWW::OpenAPIClient::Object::BatchResponseBatchFilesFilesInBatch;
...
__PACKAGE__->method_documentation({
    ...
    'file_type_description' => {
        datatype => 'string',
        base_name => 'file_type_description',
        description => 'The filetype in human readable format.',
        format => '',
        read_only => '',
            },
    'process_info' => {
        datatype => 'BatchResponseBatchFilesProcessInfo',
        base_name => 'process_info',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'scan_all_result_a' => {
        datatype => 'ProcessingResultsStringEnum',
        base_name => 'scan_all_result_a',
        description => 'The overall scan result as string',
        format => '',
        read_only => '',
            },
    'scan_all_result_i' => {
        datatype => 'ProcessingResultsIndexEnum',
        base_name => 'scan_all_result_i',
