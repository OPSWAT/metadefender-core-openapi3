...
/**
 * DLPRuleMatchResult Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class DLPRuleMatchResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DLPRuleMatchResult';
    ...
    protected static $setters = [
        ...
        'certainty_score' => 'setCertaintyScore',
        'hit' => 'setHit',
    ...
    protected static $getters = [
        ...
        'certainty_score' => 'getCertaintyScore',
        'hit' => 'getHit',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['certainty_score'] = isset($data['certainty_score']) ? $data['certainty_score'] : null;
        $this->container['hit'] = isset($data['hit']) ? $data['hit'] : null;
        $this->container['is_redacted'] = isset($data['is_redacted']) ? $data['is_redacted'] : null;
     ...
     * Sets after
     *
     * @param string|null $after The context after the matched data.
     *
     * @return $this
     */
     ...
     * Sets before
     *
     * @param string|null $before The context before the matched data.
     *
     * @return $this
     */
     ...
     * Sets certainty
     *
     * @param string|null $certainty The text version of \"certainty_score\", possible values:   * `Very Low`     * `Low`     * `Medium`     * `High`     * `Very High`
     *
     * @return $this
     */
    ...
    /**
     * Gets certainty_score
     *
     * @return int|null
     */
    public function getCertaintyScore()
    {
        return $this->container['certainty_score'];
    }

    /**
     * Sets certainty_score
     *
     * @param int|null $certainty_score Is  defined by the relevance of the given hit in its context. It is calculated based on multiple factors such as the number of digits, possible values: [0-100]
     *
     * @return $this
     */
    public function setCertaintyScore($certainty_score)
    {
        $this->container['certainty_score'] = $certainty_score;
     ...
     * Sets hit
     *
     * @param string|null $hit The matched data.
     *
     * @return $this
     */
     ...
     * Sets is_redacted
     *
     * @param bool|null $is_redacted If file was redacted or not.
     *
     * @return $this
     */
     ...
     * Sets severity
     *
     * @param int|null $severity (NOTE: this field is deprecated): can be 0 (detected) or 1 (suspicious).
     *
     * @return $this
     */
