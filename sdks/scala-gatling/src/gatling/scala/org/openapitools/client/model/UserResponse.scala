...
object UserResponse {
    def toStringBody(var_apikey: Object, var_directoryId: Object, var_displayName: Object, var_email: Object, var_name: Object, var_roles: Object, var_uiSettings: Object) =
        s"""
        | {
        | "apikey":$var_apikey,"directoryId":$var_directoryId,"displayName":$var_displayName,"email":$var_email,"name":$var_name,"roles":$var_roles,"uiSettings":$var_uiSettings
        | }
        """.stripMargin
}
