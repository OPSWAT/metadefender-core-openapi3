...
public class YaraController  {
  ...
  /*
    public ResponseContext yaraPackageGenerate(RequestContext request , String apikey) {
        return new ResponseContext().status(Status.INTERNAL_SERVER_ERROR).entity( "Not implemented" );
    }
  */

  /*
    public ResponseContext yaraPackageStatus(RequestContext request , String apikey) {
        return new ResponseContext().status(Status.INTERNAL_SERVER_ERROR).entity( "Not implemented" );
    }
  */
