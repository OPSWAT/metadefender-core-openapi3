...
class ProcessingResultsStringEnum(object):
    ...
    allowable_values = [THREAT_DETECTED, INFECTED, SUSPICIOUS, FAILED, CLEANED_DELETED, SCAN_SKIPPED_WHITELISTED, SCAN_SKIPPED_BLACKLISTED, EXCEEDED_ARCHIVE_DEPTH, NOT_SCANNED, ENCRYPTED_ARCHIVE, EXCEEDED_ARCHIVE_SIZE, EXCEEDED_ARCHIVE_FILE_NUMBER, PASSWORD_PROTECTED_DOCUMENT, EXCEEDED_ARCHIVE_TIMEOUT, FILE_TYPE_MISMATCH, POTENTIALLY_VULNERABLE_FILE, CANCELED, SENSITIVE_DATA_FOUND, YARA_RULE_MATCHED, POTENTIALLY_UNWANTED_PROGRAM, UNSUPPORTED_FILE_TYPE, IN_PROGRESS]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """ProcessingResultsStringEnum - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProcessingResultsStringEnum):
            return False
